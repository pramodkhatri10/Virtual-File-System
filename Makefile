...
BLOCKSIZE=512
CC=gcc
CFLAGS= -w -lm -lreadline -I.
LIBS =pthread
DEPS = 
ADDOBJ= fsLow.o b_io.o volumeControlBlock.o linkedListFreeSpaceMap.o mfs.o
...
volumeFormatter: volumeFormatter.o $(ADDOBJ)
	$(CC) -o $@ $^ $(CFLAGS) -l $(LIBS)
...
format:
	...
	./volumeFormatter $(VOLUMENAME) $(VOLUMESIZE) $(BLOCKSIZE)
